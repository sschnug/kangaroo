/*!
	@file opt2val1rangesdvzt.tcc
	@brief The source file for Opt2Val1RangeSdVZt template class.
	@details This is the source file for Opt2Val1RangeSdVZt template class.
...
#ifndef Opt2Val1RangeSdVZtTccIncluded
#define Opt2Val1RangeSdVZtTccIncluded
...
class Opt2Val1RangeSdVZt : public SdZt<zt>
{
	public:
		...
		static Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> & cast(Selc & theSelc);				//!< Perform casting.
		static Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> * cast(Selc * theSelc);				//!< Perform casting.
		static Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const & cast(Selc const & theSelc);	//!< Perform casting.
		static Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const * cast(Selc const * theSelc);	//!< Perform casting.
	...
	private:
		...
		Opt2Val1RangeSdVZt(Fss const theFss, Hdl const hdlSys,
										Prm * prmTerm, Dim const PrmCount);							//!< Constructor.
		Opt2Val1RangeSdVZt(Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const & that);		//!< Duplicator.
		Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const & operator =
									(Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const & that);	//!< Assigner.
		~Opt2Val1RangeSdVZt();																	//!< Destructor.
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Bll Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::suit(Selc const & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls;
	CatchError
}
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Bll Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::suit(Selc & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls;
	CatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> &
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::cast(Selc & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls) Wtxt(eWrongCls);

	return scast<Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> &>(theSelc);
	CatchError
}
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const &
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::cast(Selc const & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls) Wtxt(eWrongCls);

	return scast<Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const &>(theSelc);
	CatchError
}
...
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> &
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::refm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> *
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::ptrm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const &
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::refc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const *
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::ptrc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::~Opt2Val1RangeSdVZt()
{
	WatchError
	//	nothing to be done.
	CatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::Opt2Val1RangeSdVZt
		(Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const & that) : SdZt<zt>(that)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const &
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::operator =
		(Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> const & that)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
Hdl Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::def(Fss const theFss, Hdl const hdlSys,
		Prm const & prmTerm0, Prm const & prmTerm1)
{
	WatchError
	Prm tPrms[2] = { prmTerm0, prmTerm1 };
	Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> * tSdXF =
		new Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>(theFss, hdlSys, tPrms, 2);
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::Opt2Val1RangeSdVZt(Fss const theFss, Hdl const hdlSys,
		Prm * thePrms, Dim const PrmCount) : SdZt<zt>(hdlSys, PrmCount), mDynaRange(false),
		mIncludeCurr(false)
{
	WatchError
	this->setSelcCls(SelcStub< Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls);
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
void Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::require(Bll const SetNotUnset)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
Bll Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::select(Rnd & theRnd)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline void Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::setDynaRange(Bll const SetNotUnset)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline void Opt2Val1RangeSdVZt<vt,zt,theOrd0,theOrd1>::includeCurrValue(Bll const SetNotUnset)
{
	WatchError
...
#endif	//Opt2Val1RangeSdVZtTccIncluded
