/*!
	@file opt1val1dynarangesdvzt.tcc
	@brief The source file for Opt1Val1DynaRangeSdVZt template class.
	@details This is the source file for Opt1Val1DynaRangeSdVZt template class.
...
#ifndef Opt1Val1DynaRangeSdVZtTccIncluded
#define Opt1Val1DynaRangeSdVZtTccIncluded
...
/*!
	@class Opt1Val1DynaRangeSdVZt
	@brief A template class to represent optimum value dynamic range single variable selcs.
	@details This template class represents optimum value dynamic range single variable selcs.
*/
template<typename vt, typename zt, Ord theOrd>
class Opt1Val1DynaRangeSdVZt : public SdZt<zt>
{
	public:

		static Hdl def(Fss const theFss, Hdl const hdlSys, Prm const & prmTerm);	//!< Define a selc.

		static Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> &
							refm(Hdl const hdlSys, Hdl const hdlSelc);				//!< Refer to a selc.
		static Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> *
							ptrm(Hdl const hdlSys, Hdl const hdlSelc);				//!< Point to a selc.
		static Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const &
		...
		static Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> & cast(Selc & theSelc);				//!< Perform casting.
		static Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> * cast(Selc * theSelc);				//!< Perform casting.
		static Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const & cast(Selc const & theSelc);	//!< Perform casting.
		static Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const * cast(Selc const * theSelc);	//!< Perform casting.
	...
	private:
		...
		Opt1Val1DynaRangeSdVZt(Fss const theFss, Hdl const hdlSys,
										Prm * prmTerm, Dim const PrmCount);					//!< Constructor.
		Opt1Val1DynaRangeSdVZt(Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const & that);			//!< Duplicator.
		Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const & operator =
									(Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const & that);	//!< Assigner.
		~Opt1Val1DynaRangeSdVZt();															//!< Destructor.
...
*/
template<typename vt, typename zt, Ord theOrd>
inline Bll Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::suit(Selc const & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> >::SelcCls;
	CatchError
}
...
*/
template<typename vt, typename zt, Ord theOrd>
inline Bll Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::suit(Selc & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> >::SelcCls;
	CatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
inline Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> &
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::cast(Selc & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> &>(theSelc);
	CatchError
}
...
*/
template<typename vt, typename zt, Ord theOrd>
inline Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const &
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::cast(Selc const & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const &>(theSelc);
	CatchError
}
...
template<typename vt, typename zt, Ord theOrd>
inline Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> &
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::refm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd>
inline Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> *
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::ptrm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd>
inline Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const &
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::refc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd>
inline Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const *
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::ptrc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
inline Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::~Opt1Val1DynaRangeSdVZt()
{
	WatchError
	//	nothing to be done.
	CatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::Opt1Val1DynaRangeSdVZt
		(Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const & that) : SdZt<zt>(that)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const &
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::operator =
		(Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> const & that)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
Hdl Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::def(Fss const theFss, Hdl const hdlSys, Prm const & prmTerm)
{
	WatchError
	Prm tPrms[1] = { prmTerm };
	Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> * tSdXF =
		new Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>(theFss, hdlSys, tPrms, 1);
...
*/
template<typename vt, typename zt, Ord theOrd>
Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::Opt1Val1DynaRangeSdVZt(Fss const theFss, Hdl const hdlSys,
		Prm * thePrms, Dim const PrmCount) : SdZt<zt>(hdlSys, PrmCount), mIncludeCurr(false)
{
	WatchError
	this->setSelcCls(SelcStub< Opt1Val1DynaRangeSdVZt<vt,zt,theOrd> >::SelcCls);
...
*/
template<typename vt, typename zt, Ord theOrd>
void Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::require(Bll const SetNotUnset)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
Bll Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::select(Rnd & theRnd)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
inline void Opt1Val1DynaRangeSdVZt<vt,zt,theOrd>::includeCurrValue(Bll const SetNotUnset)
{
	WatchError
...
#endif	//Opt1Val1DynaRangeSdVZtTccIncluded
