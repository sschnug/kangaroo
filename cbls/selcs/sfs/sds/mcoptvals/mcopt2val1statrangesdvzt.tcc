/*!
	@file mcopt2val1statrangesdvzt.tcc
	@brief The source file for McOpt2Val1StatRangeSdVZt template class.
	@details This is the source file for McOpt2Val1StatRangeSdVZt template class.
...
#ifndef McOpt2Val1StatRangeSdVZtTccIncluded
#define McOpt2Val1StatRangeSdVZtTccIncluded
...
/*!
	@class McOpt2Val1StatRangeSdVZt
...
class McOpt2Val1StatRangeSdVZt : public SdZt<zt>
{
	public:
		...
		static McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> &
							refm(Hdl const hdlSys, Hdl const hdlSelc);				//!< Refer to a selc.
		static McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> *
							ptrm(Hdl const hdlSys, Hdl const hdlSelc);				//!< Point to a selc.
		static McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const &
		...
		static McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> & cast(Selc & theSelc);				//!< Perform casting.
		static McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> * cast(Selc * theSelc);				//!< Perform casting.
		static McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const & cast(Selc const & theSelc);	//!< Perform casting.
		static McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const * cast(Selc const * theSelc);	//!< Perform casting.
	...
	private:
		...
		McOpt2Val1StatRangeSdVZt(Fss const theFss, Hdl const hdlSys,
					Prm * prmTerm, Dim const PrmCount, Dim const SamplePercent);					//!< Constructor.
		McOpt2Val1StatRangeSdVZt(McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const & that);		//!< Duplicator.
		McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const & operator =
									(McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const & that);	//!< Assigner.
		~McOpt2Val1StatRangeSdVZt();																//!< Destructor.
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Bll McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::suit(Selc const & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls;
	CatchError
}
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline Bll McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::suit(Selc & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls;
	CatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> &
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::cast(Selc & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls) Wtxt(eWrongCls);

	return scast<McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> &>(theSelc);
	CatchError
}
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const &
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::cast(Selc const & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls) Wtxt(eWrongCls);

	return scast<McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const &>(theSelc);
	CatchError
}
...
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> &
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::refm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> *
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::ptrm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const &
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::refc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const *
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::ptrc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
inline McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::~McOpt2Val1StatRangeSdVZt()
{
	WatchError
	//	nothing to be done.
	CatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::McOpt2Val1StatRangeSdVZt
		(McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const & that) : SdZt<zt>(that)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const &
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::operator =
		(McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> const & that)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
Hdl McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::def(Fss const theFss, Hdl const hdlSys,
		Prm const & prmTerm0, Prm const & prmTerm1, Dim const SamplePercent)
{
	WatchError
	Prm tPrms[2] = { prmTerm0, prmTerm1 };
	McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> * tSdXF =
		new McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>(theFss, hdlSys, tPrms, 2, SamplePercent);
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::McOpt2Val1StatRangeSdVZt(Fss const theFss, Hdl const hdlSys,
			...
			mSamplePercent(SamplePercent)
{
	...
	this->setSelcCls(SelcStub< McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1> >::SelcCls);
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
void McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::require(Bll const SetNotUnset)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd0, Ord theOrd1>
Bll McOpt2Val1StatRangeSdVZt<vt,zt,theOrd0,theOrd1>::select(Rnd & theRnd)
{
	WatchError
...
#endif	//McOpt2Val1StatRangeSdVZtTccIncluded
