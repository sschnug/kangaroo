/*!
	@file mcopt1val1rangesdvzt.tcc
	@brief The source file for Opt1Val1RangeSdVZt template class.
	@details This is the source file for McOpt1Val1RangeSdVZt template class.
...
#ifndef McOpt1Val1RangeSdVZtTccIncluded
#define McOpt1Val1RangeSdVZtTccIncluded
...
/*!
	@class McOpt1Val1RangeSdVZt
	@brief A template class to represent Monte Carlo optimum value range single variable selcs.
	@details This template class represents Monte Carlo optimum value range single variable selcs.
*/
template<typename vt, typename zt, Ord theOrd>
class McOpt1Val1RangeSdVZt : public SdZt<zt>
{
	public:
		...
		static McOpt1Val1RangeSdVZt<vt,zt,theOrd> & cast(Selc & theSelc);				//!< Perform casting.
		static McOpt1Val1RangeSdVZt<vt,zt,theOrd> * cast(Selc * theSelc);				//!< Perform casting.
		static McOpt1Val1RangeSdVZt<vt,zt,theOrd> const & cast(Selc const & theSelc);	//!< Perform casting.
		static McOpt1Val1RangeSdVZt<vt,zt,theOrd> const * cast(Selc const * theSelc);	//!< Perform casting.
	...
	private:
		...
		McOpt1Val1RangeSdVZt(Fss const theFss, Hdl const hdlSys,
				Prm * prmTerm, Dim const PrmCount, Dim const SamplePercent);			//!< Constructor.
		McOpt1Val1RangeSdVZt(McOpt1Val1RangeSdVZt<vt,zt,theOrd> const & that);			//!< Duplicator.
		McOpt1Val1RangeSdVZt<vt,zt,theOrd> const & operator =
									(McOpt1Val1RangeSdVZt<vt,zt,theOrd> const & that);	//!< Assigner.
		~McOpt1Val1RangeSdVZt();														//!< Destructor.
...
*/
template<typename vt, typename zt, Ord theOrd>
inline Bll McOpt1Val1RangeSdVZt<vt,zt,theOrd>::suit(Selc const & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< McOpt1Val1RangeSdVZt<vt,zt,theOrd> >::SelcCls;
	CatchError
}
...
*/
template<typename vt, typename zt, Ord theOrd>
inline Bll McOpt1Val1RangeSdVZt<vt,zt,theOrd>::suit(Selc & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< McOpt1Val1RangeSdVZt<vt,zt,theOrd> >::SelcCls;
	CatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
inline McOpt1Val1RangeSdVZt<vt,zt,theOrd> &
McOpt1Val1RangeSdVZt<vt,zt,theOrd>::cast(Selc & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< McOpt1Val1RangeSdVZt<vt,zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<McOpt1Val1RangeSdVZt<vt,zt,theOrd> &>(theSelc);
	CatchError
}
...
*/
template<typename vt, typename zt, Ord theOrd>
inline McOpt1Val1RangeSdVZt<vt,zt,theOrd> const &
McOpt1Val1RangeSdVZt<vt,zt,theOrd>::cast(Selc const & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< McOpt1Val1RangeSdVZt<vt,zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<McOpt1Val1RangeSdVZt<vt,zt,theOrd> const &>(theSelc);
	CatchError
}
...
template<typename vt, typename zt, Ord theOrd>
inline McOpt1Val1RangeSdVZt<vt,zt,theOrd> &
McOpt1Val1RangeSdVZt<vt,zt,theOrd>::refm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd>
inline McOpt1Val1RangeSdVZt<vt,zt,theOrd> *
McOpt1Val1RangeSdVZt<vt,zt,theOrd>::ptrm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd>
inline McOpt1Val1RangeSdVZt<vt,zt,theOrd> const &
McOpt1Val1RangeSdVZt<vt,zt,theOrd>::refc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename vt, typename zt, Ord theOrd>
inline McOpt1Val1RangeSdVZt<vt,zt,theOrd> const *
McOpt1Val1RangeSdVZt<vt,zt,theOrd>::ptrc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
inline McOpt1Val1RangeSdVZt<vt,zt,theOrd>::~McOpt1Val1RangeSdVZt()
{
	WatchError
	//	nothing to be done.
	CatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
McOpt1Val1RangeSdVZt<vt,zt,theOrd>::McOpt1Val1RangeSdVZt
		(McOpt1Val1RangeSdVZt<vt,zt,theOrd> const & that) : SdZt<zt>(that)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
McOpt1Val1RangeSdVZt<vt,zt,theOrd> const &
McOpt1Val1RangeSdVZt<vt,zt,theOrd>::operator =
		(McOpt1Val1RangeSdVZt<vt,zt,theOrd> const & that)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
Hdl McOpt1Val1RangeSdVZt<vt,zt,theOrd>::def(Fss const theFss, Hdl const hdlSys,
		Prm const & prmTerm, Dim const SamplePercent)
{
	WatchError
	Prm tPrms[1] = { prmTerm };
	McOpt1Val1RangeSdVZt<vt,zt,theOrd> * tSdXF =
		new McOpt1Val1RangeSdVZt<vt,zt,theOrd>(theFss, hdlSys, tPrms, 1, SamplePercent);
...
*/
template<typename vt, typename zt, Ord theOrd>
McOpt1Val1RangeSdVZt<vt,zt,theOrd>::McOpt1Val1RangeSdVZt(Fss const theFss, Hdl const hdlSys,
		Prm * thePrms, Dim const PrmCount, Dim const SamplePercent) :
		SdZt<zt>(hdlSys, PrmCount), mDynaRange(false),
		mSamplePercent(SamplePercent)
{
	WatchError
	Warn(!SamplePercent, eEmptyDimension);
	this->setSelcCls(SelcStub< McOpt1Val1RangeSdVZt<vt,zt,theOrd> >::SelcCls);
...
*/
template<typename vt, typename zt, Ord theOrd>
void McOpt1Val1RangeSdVZt<vt,zt,theOrd>::require(Bll const SetNotUnset)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
Bll McOpt1Val1RangeSdVZt<vt,zt,theOrd>::select(Rnd & theRnd)
{
	WatchError
...
*/
template<typename vt, typename zt, Ord theOrd>
inline void McOpt1Val1RangeSdVZt<vt,zt,theOrd>::setDynaRange(Bll const SetNotUnset)
{
	WatchError
...
#endif	//McOpt1Val1RangeSdVZtTccIncluded
