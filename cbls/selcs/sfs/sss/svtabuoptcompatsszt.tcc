/*!
	@file svtabuoptcompatsszt.tcc
	@brief The source file for SvTabuOptCompatSsZt template class.
	@details This is the source file for SvTabuOptCompatSsZt template class.
...
#ifndef SvTabuOptCompatSsZtTccIncluded
#define SvTabuOptCompatSsZtTccIncluded
...
class SvTabuOptCompatSsZt : public SsZt<zt>
{
	public:

		static Hdl def(Fss const theFss, Hdl const hdlSys, Prm const & prmTerm, Typ const typTabu);	//!< Define a full swap.
		static SvTabuOptCompatSsZt<zt,theOrd> const & refc(Hdl const hdlSys, Hdl const hdlSelc);//!< Refer to a selc.
		static SvTabuOptCompatSsZt<zt,theOrd> const * ptrc(Hdl const hdlSys, Hdl const hdlSelc);//!< Point to a selc.
		static SvTabuOptCompatSsZt<zt,theOrd> & refm(Hdl const hdlSys, Hdl const hdlSelc);		//!< Refer to a selc.
		static SvTabuOptCompatSsZt<zt,theOrd> * ptrm(Hdl const hdlSys, Hdl const hdlSelc);		//!< Point to a selc.
		...
		static SvTabuOptCompatSsZt<zt,theOrd> & cast(Selc & theSelc);				//!< Perform casting.
		static SvTabuOptCompatSsZt<zt,theOrd> * cast(Selc * theSelc);				//!< Perform casting.
		static SvTabuOptCompatSsZt<zt,theOrd> const & cast(Selc const & theSelc);	//!< Perform casting.
		static SvTabuOptCompatSsZt<zt,theOrd> const * cast(Selc const * theSelc);	//!< Perform casting.
	...
	private:
		...
		SvTabuOptCompatSsZt(Fss const theFss, Hdl const hdlSys,
					Prm * prmTerm, Dim const PrmCount, Typ const typTabu);		//!< Constructor.
		SvTabuOptCompatSsZt(SvTabuOptCompatSsZt<zt,theOrd> const & that);	//!< Duplicator.
		SvTabuOptCompatSsZt<zt,theOrd> const & operator =
							(SvTabuOptCompatSsZt<zt,theOrd> const & that);	//!< Assigner.
		~SvTabuOptCompatSsZt();												//!< Destructor.
...
*/
template<typename zt, Ord theOrd>
inline Bln SvTabuOptCompatSsZt<zt,theOrd>::suit(Selc const & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< SvTabuOptCompatSsZt<zt,theOrd> >::SelcCls;
	CatchError
}
...
*/
template<typename zt, Ord theOrd>
inline Bln SvTabuOptCompatSsZt<zt,theOrd>::suit(Selc & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< SvTabuOptCompatSsZt<zt,theOrd> >::SelcCls;
	CatchError
...
*/
template<typename zt, Ord theOrd>
inline SvTabuOptCompatSsZt<zt,theOrd> & SvTabuOptCompatSsZt<zt,theOrd>::cast(Selc & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< SvTabuOptCompatSsZt<zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<SvTabuOptCompatSsZt<zt,theOrd> &>(theSelc);
	CatchError
}
...
*/
template<typename zt, Ord theOrd>
inline SvTabuOptCompatSsZt<zt,theOrd> const & SvTabuOptCompatSsZt<zt,theOrd>::cast(Selc const & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< SvTabuOptCompatSsZt<zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<SvTabuOptCompatSsZt<zt,theOrd> const &>(theSelc);
	CatchError
}
...
*/
template<typename zt, Ord theOrd>
inline SvTabuOptCompatSsZt<zt,theOrd> const &
SvTabuOptCompatSsZt<zt,theOrd>::refc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename zt, Ord theOrd>
inline SvTabuOptCompatSsZt<zt,theOrd> const *
SvTabuOptCompatSsZt<zt,theOrd>::ptrc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
inline SvTabuOptCompatSsZt<zt,theOrd> &
SvTabuOptCompatSsZt<zt,theOrd>::refm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename zt, Ord theOrd>
inline SvTabuOptCompatSsZt<zt,theOrd> *
SvTabuOptCompatSsZt<zt,theOrd>::ptrm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
inline SvTabuOptCompatSsZt<zt,theOrd>::~SvTabuOptCompatSsZt()
{
	WatchError
	//	nothing to be done.
	CatchError
...
*/
template<typename zt, Ord theOrd>
SvTabuOptCompatSsZt<zt,theOrd>::SvTabuOptCompatSsZt(SvTabuOptCompatSsZt<zt,theOrd> const & that) :
...
*/
template<typename zt, Ord theOrd>
SvTabuOptCompatSsZt<zt,theOrd> const &
SvTabuOptCompatSsZt<zt,theOrd>::operator = (SvTabuOptCompatSsZt<zt,theOrd> const & that)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
Hdl SvTabuOptCompatSsZt<zt,theOrd>::def(Fss const theFss, Hdl const hdlSys,
	Prm const & prmTerm, Typ const typTabu)
{
	WatchError
	Prm tPrms[1] = { prmTerm };
	SvTabuOptCompatSsZt<zt,theOrd> * tSsX =
		new SvTabuOptCompatSsZt<zt,theOrd>(theFss, hdlSys, tPrms, 1, typTabu);
...
*/
template<typename zt, Ord theOrd>
SvTabuOptCompatSsZt<zt,theOrd>::SvTabuOptCompatSsZt(Fss const theFss, Hdl const hdlSys,
		Prm * thePrms, Dim const PrmCount, Typ const typTabu) : SsZt<zt>(hdlSys, PrmCount),
		mSysTabu(SvTabu::refc(hdlSys,typTabu))
{
	WatchError
	this->setSelcCls(SelcStub< SvTabuOptCompatSsZt<zt,theOrd> >::SelcCls);
...
*/
template<typename zt, Ord theOrd>
void SvTabuOptCompatSsZt<zt,theOrd>::require(Bll const SetNotUnset)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
Bll SvTabuOptCompatSsZt<zt,theOrd>::select(Rnd & theRnd)
{
	WatchError
...
#endif	//SvTabuOptCompatSsZtTccIncluded
