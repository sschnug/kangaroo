/*!
	@file optidensszt.tcc
	@brief The source file for OptIdenSsZt template class.
	@details This is the source file for OptIdenSsZt template class.
...
#ifndef OptIdenSsZtTccIncluded
#define OptIdenSsZtTccIncluded
...
class OptIdenSsZt : public SsZt<zt>
{
	public:

		static Hdl def(Fss const theFss, Hdl const hdlSys, Prm const & prmTerm);			//!< Define a full swap.
		static OptIdenSsZt<zt,theOrd> const & refc(Hdl const hdlSys, Hdl const hdlSelc);	//!< Refer to a selc.
		static OptIdenSsZt<zt,theOrd> const * ptrc(Hdl const hdlSys, Hdl const hdlSelc);	//!< Point to a selc.
		static OptIdenSsZt<zt,theOrd> & refm(Hdl const hdlSys, Hdl const hdlSelc);			//!< Refer to a selc.
		static OptIdenSsZt<zt,theOrd> * ptrm(Hdl const hdlSys, Hdl const hdlSelc);			//!< Point to a selc.
		...
		static OptIdenSsZt<zt,theOrd> & cast(Selc & theSelc);				//!< Perform casting.
		static OptIdenSsZt<zt,theOrd> * cast(Selc * theSelc);				//!< Perform casting.
		static OptIdenSsZt<zt,theOrd> const & cast(Selc const & theSelc);	//!< Perform casting.
		static OptIdenSsZt<zt,theOrd> const * cast(Selc const * theSelc);	//!< Perform casting.
	...
	private:
		...
		OptIdenSsZt(Fss const theFss, Hdl const hdlSys,
										Prm * prmTerm, Dim const PrmCount);					//!< Constructor.
		OptIdenSsZt(OptIdenSsZt<zt,theOrd> const & that);									//!< Duplicator.
		OptIdenSsZt<zt,theOrd> const & operator = (OptIdenSsZt<zt,theOrd> const & that);	//!< Assigner.
		~OptIdenSsZt();																	//!< Destructor.
...
*/
template<typename zt, Ord theOrd>
inline Bln OptIdenSsZt<zt,theOrd>::suit(Selc const & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< OptIdenSsZt<zt,theOrd> >::SelcCls;
	CatchError
}
...
*/
template<typename zt, Ord theOrd>
inline Bln OptIdenSsZt<zt,theOrd>::suit(Selc & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< OptIdenSsZt<zt,theOrd> >::SelcCls;
	CatchError
...
*/
template<typename zt, Ord theOrd>
inline OptIdenSsZt<zt,theOrd> & OptIdenSsZt<zt,theOrd>::cast(Selc & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< OptIdenSsZt<zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<OptIdenSsZt<zt,theOrd> &>(theSelc);
	CatchError
}
...
*/
template<typename zt, Ord theOrd>
inline OptIdenSsZt<zt,theOrd> const & OptIdenSsZt<zt,theOrd>::cast(Selc const & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< OptIdenSsZt<zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<OptIdenSsZt<zt,theOrd> const &>(theSelc);
	CatchError
}
...
*/
template<typename zt, Ord theOrd>
inline OptIdenSsZt<zt,theOrd> const &
OptIdenSsZt<zt,theOrd>::refc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename zt, Ord theOrd>
inline OptIdenSsZt<zt,theOrd> const *
OptIdenSsZt<zt,theOrd>::ptrc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
inline OptIdenSsZt<zt,theOrd> &
OptIdenSsZt<zt,theOrd>::refm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename zt, Ord theOrd>
inline OptIdenSsZt<zt,theOrd> *
OptIdenSsZt<zt,theOrd>::ptrm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
inline OptIdenSsZt<zt,theOrd>::~OptIdenSsZt()
{
	WatchError
	//	nothing to be done.
	CatchError
...
*/
template<typename zt, Ord theOrd>
OptIdenSsZt<zt,theOrd>::OptIdenSsZt(OptIdenSsZt<zt,theOrd> const & that) : SsZt<zt>(that)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
OptIdenSsZt<zt,theOrd> const & OptIdenSsZt<zt,theOrd>::operator = (OptIdenSsZt<zt,theOrd> const & that)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
Hdl OptIdenSsZt<zt,theOrd>::def(Fss const theFss, Hdl const hdlSys, Prm const & prmTerm)
{
	WatchError
	Prm tPrms[1] = { prmTerm };
	OptIdenSsZt<zt,theOrd> * tSsX = new OptIdenSsZt<zt,theOrd>(theFss, hdlSys, tPrms, 1);
...
*/
template<typename zt, Ord theOrd>
OptIdenSsZt<zt,theOrd>::OptIdenSsZt(Fss const theFss, Hdl const hdlSys,
		Prm * thePrms, Dim const PrmCount) : SsZt<zt>(hdlSys, PrmCount)
{
	WatchError
	this->setSelcCls(SelcStub< OptIdenSsZt<zt,theOrd> >::SelcCls);
...
*/
template<typename zt, Ord theOrd>
void OptIdenSsZt<zt,theOrd>::require(Bll const SetNotUnset)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
Bll OptIdenSsZt<zt,theOrd>::select(Rnd & theRnd)
{
	WatchError
