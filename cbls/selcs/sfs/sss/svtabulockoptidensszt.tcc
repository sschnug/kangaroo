/*!
	...
	@brief The source file for SvTabuLockOptIdenSsZt template class.
	@details This is the source file for SvTabuLockOptIdenSsZt template class.
...
#ifndef SvTabuLockOptIdenSsZtTccIncluded
#define SvTabuLockOptIdenSsZtTccIncluded
...
class SvTabuLockOptIdenSsZt : public SsZt<zt>
{
	public:

		static Hdl def(Fss const theFss, Hdl const hdlSys, Prm const & prmTerm, Typ const typTabu);	//!< Define a full swap.
		static SvTabuLockOptIdenSsZt<zt,theOrd> const & refc(Hdl const hdlSys, Hdl const hdlSelc);	//!< Refer to a selc.
		static SvTabuLockOptIdenSsZt<zt,theOrd> const * ptrc(Hdl const hdlSys, Hdl const hdlSelc);	//!< Point to a selc.
		static SvTabuLockOptIdenSsZt<zt,theOrd> & refm(Hdl const hdlSys, Hdl const hdlSelc);		//!< Refer to a selc.
		static SvTabuLockOptIdenSsZt<zt,theOrd> * ptrm(Hdl const hdlSys, Hdl const hdlSelc);		//!< Point to a selc.
		...
		static SvTabuLockOptIdenSsZt<zt,theOrd> & cast(Selc & theSelc);				//!< Perform casting.
		static SvTabuLockOptIdenSsZt<zt,theOrd> * cast(Selc * theSelc);				//!< Perform casting.
		static SvTabuLockOptIdenSsZt<zt,theOrd> const & cast(Selc const & theSelc);	//!< Perform casting.
		static SvTabuLockOptIdenSsZt<zt,theOrd> const * cast(Selc const * theSelc);	//!< Perform casting.
	...
	private:
		...
		SvTabuLockOptIdenSsZt(Fss const theFss, Hdl const hdlSys,
					Prm * prmTerm, Dim const PrmCount, Typ const typTabu);		//!< Constructor.
		SvTabuLockOptIdenSsZt(SvTabuLockOptIdenSsZt<zt,theOrd> const & that);	//!< Duplicator.
		SvTabuLockOptIdenSsZt<zt,theOrd> const & operator =
							(SvTabuLockOptIdenSsZt<zt,theOrd> const & that);	//!< Assigner.
		~SvTabuLockOptIdenSsZt();												//!< Destructor.
...
*/
template<typename zt, Ord theOrd>
inline Bln SvTabuLockOptIdenSsZt<zt,theOrd>::suit(Selc const & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< SvTabuLockOptIdenSsZt<zt,theOrd> >::SelcCls;
	CatchError
}
...
*/
template<typename zt, Ord theOrd>
inline Bln SvTabuLockOptIdenSsZt<zt,theOrd>::suit(Selc & theSelc)
{
	WatchError
	return theSelc.SelcCls == SelcStub< SvTabuLockOptIdenSsZt<zt,theOrd> >::SelcCls;
	CatchError
...
*/
template<typename zt, Ord theOrd>
inline SvTabuLockOptIdenSsZt<zt,theOrd> & SvTabuLockOptIdenSsZt<zt,theOrd>::cast(Selc & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< SvTabuLockOptIdenSsZt<zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<SvTabuLockOptIdenSsZt<zt,theOrd> &>(theSelc);
	CatchError
}
...
*/
template<typename zt, Ord theOrd>
inline SvTabuLockOptIdenSsZt<zt,theOrd> const & SvTabuLockOptIdenSsZt<zt,theOrd>::cast(Selc const & theSelc)
{
	WatchError
	Wchk(theSelc.SelcCls != SelcStub< SvTabuLockOptIdenSsZt<zt,theOrd> >::SelcCls) Wtxt(eWrongCls);

	return scast<SvTabuLockOptIdenSsZt<zt,theOrd> const &>(theSelc);
	CatchError
}
...
*/
template<typename zt, Ord theOrd>
inline SvTabuLockOptIdenSsZt<zt,theOrd> const &
SvTabuLockOptIdenSsZt<zt,theOrd>::refc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename zt, Ord theOrd>
inline SvTabuLockOptIdenSsZt<zt,theOrd> const *
SvTabuLockOptIdenSsZt<zt,theOrd>::ptrc(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
inline SvTabuLockOptIdenSsZt<zt,theOrd> &
SvTabuLockOptIdenSsZt<zt,theOrd>::refm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
template<typename zt, Ord theOrd>
inline SvTabuLockOptIdenSsZt<zt,theOrd> *
SvTabuLockOptIdenSsZt<zt,theOrd>::ptrm(Hdl const hdlSys, Hdl const hdlSelc)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
inline SvTabuLockOptIdenSsZt<zt,theOrd>::~SvTabuLockOptIdenSsZt()
{
	WatchError
	//	nothing to be done.
	CatchError
...
*/
template<typename zt, Ord theOrd>
SvTabuLockOptIdenSsZt<zt,theOrd>::SvTabuLockOptIdenSsZt(SvTabuLockOptIdenSsZt<zt,theOrd> const & that) :
...
*/
template<typename zt, Ord theOrd>
SvTabuLockOptIdenSsZt<zt,theOrd> const &
SvTabuLockOptIdenSsZt<zt,theOrd>::operator = (SvTabuLockOptIdenSsZt<zt,theOrd> const & that)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
Hdl SvTabuLockOptIdenSsZt<zt,theOrd>::def(Fss const theFss, Hdl const hdlSys,
	Prm const & prmTerm, Typ const typTabu)
{
	WatchError
	Prm tPrms[1] = { prmTerm };
	SvTabuLockOptIdenSsZt<zt,theOrd> * tSsX =
		new SvTabuLockOptIdenSsZt<zt,theOrd>(theFss, hdlSys, tPrms, 1, typTabu);
...
*/
template<typename zt, Ord theOrd>
SvTabuLockOptIdenSsZt<zt,theOrd>::SvTabuLockOptIdenSsZt(Fss const theFss, Hdl const hdlSys,
		Prm * thePrms, Dim const PrmCount, Typ const typTabu) : SsZt<zt>(hdlSys, PrmCount),
		mSysTabu(SvTabu::refc(hdlSys,typTabu))
{
	WatchError
	this->setSelcCls(SelcStub< SvTabuLockOptIdenSsZt<zt,theOrd> >::SelcCls);
...
*/
template<typename zt, Ord theOrd>
void SvTabuLockOptIdenSsZt<zt,theOrd>::require(Bll const SetNotUnset)
{
	WatchError
...
*/
template<typename zt, Ord theOrd>
Bll SvTabuLockOptIdenSsZt<zt,theOrd>::select(Rnd & theRnd)
{
	WatchError
...
#endif	//SvTabuLockOptIdenSsZtTccIncluded
